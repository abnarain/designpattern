...
//class MyStringBuilder extends StringBuilder -- cannot as StringBuilder is a final class
class MyStringBuilder
{
    ...
    {
        //brand new string builder that has nothing to do with
        // current builder that we are working with
    ...
    public MyStringBuilder append(String str) {
        sb.append(str);
        return this; //TODO THE CHANGE NEEDS TO BE MADE!
    }
